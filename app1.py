...
def asymmetric_mse(y_true, y_pred):
    diff = y_pred - y_true
    # Penalizes underestimation (actual > predicted) more heavily
...
def load_model_and_scaler(model_dir):
    model = keras.models.load_model(
        ...
        custom_objects={"TCN": TCN, "asymmetric_mse": asymmetric_mse}
    )
...
st.subheader("📤 Step 1: Upload 30-Day Meteorological Data")
...
if uploaded_file is not None:
    ...
    # --- 6. Feature Validation & Engineering ---
    Q95_THRESHOLD = 47.73  # As determined from your training output
    
    # Separate physical features from the derived 'is_extreme' column
    ...
    # Automatically create the 8th feature (is_extreme)
